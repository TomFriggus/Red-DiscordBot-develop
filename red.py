...
#
# Aaron, a Discord bot by Mason & Evan, based on discord.py and its command
#                             extension.
#
#                   https://github.com/M&E/
#
#
# Aaron.py and cogs/utils/checks.py both contain some modified functions
#                     originally made by Rapptz.
#
#                 https://github.com/Rapptz/RoboDanny/
#

description = "Aaron - A multifunction Discord bot by Mason & Evan"
...
class Bot(commands.Bot):
    ...
    async def shutdown(self, *, restart=False):
        """Gracefully quits Aaron with exit code 0
...
def initialize(bot_class=Bot, formatter_class=Formatter):
    ...
    async def on_ready():
        ...
        print("\nOfficial server: https://discord.gg/aaron")
...
def interactive_setup(settings):
    ...
    if first_run:
        print("Aaron - First run configuration\n")
        print("If you haven't already, create a new account:\n"
              "https://www.M&E.tech/support"
